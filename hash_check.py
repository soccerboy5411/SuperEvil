...
def hash_check(hashtype, regexstr, data):
    try:
...
hashes = (
    ...
    ("Cisco IOS SHA 256", r"^[a-zA-Z0-9]{43}$"),
    ("SHA-1 (Django)", r"^[a-zA-Z0-9]{43}$"),
